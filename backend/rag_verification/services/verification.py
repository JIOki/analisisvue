...
class VerificationService:
    ...
    def verify_response(
        ...
        try:
            ...
            MAX_RESPONSE_LENGTH = 1000  # Reducido agresivamente para evitar error 400
            ...
            if context_chunks and len(context_chunks) > 0:
                ...
                if source_chunks:
                    ...
                    max_response_length = MAX_RESPONSE_LENGTH  # Limitar respuesta para embedding
                    ...
                    # Usar un limite mas bajo para embed_text_safe
                    response_embedding = self.embedder.embed_text_safe(response_for_embedding, max_chars=800)
